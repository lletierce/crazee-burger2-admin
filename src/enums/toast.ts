...
export const EDIT_PRODUCT_SUCCESS_MESSAGE = "Produit modifié avec succès"
export const EDIT_PRODUCT_FAIL_MESSAGE = "Erreur rencontrée, impossible de modifier le produit"
